...
# called data.table and dplyr library
library(data.table)
library(dplyr)
...
# Part 1 - Merge the training and the test data sets into one data set
subject <- rbind(subjectTrain, subjectTest)
activity <- rbind(activityTrain, activityTest)
features <- rbind(featuresTrain, featuresTest)

# Naming the columns, by transpose the featureNames field into columns
...
write.table(tidyData, file = "dtTidy.txt", row.names = FALSE)
